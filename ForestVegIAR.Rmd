...
In `r paste0(params$ReportYear, ", ", if(is.na(PestData)) "0" else nrow(PestData) )`, different pests or diseases were recorded on trees and saplings. `r if(!anyNA(PestData)) paste("See the table below for summary information on each species encountered.")`
